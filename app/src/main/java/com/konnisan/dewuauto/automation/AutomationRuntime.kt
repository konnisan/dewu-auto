...
data class AutomationRuntime(
    ...
    var rehearsalCompletedCount: Int = 0,
    ...
    var finalConfirmationClickCount: Int = 0,
    var finalConfirmationEnabled: Boolean = false,
    var targetTaskCount: Int = 1,
    var requiresCreatorEnrollment: Boolean = false,
    var taskResults: List<PreviewTaskResult> = emptyList(),
